  ...
  return (
    <section className="w-full py-20 px-4 md:px-8 bg-white flex justify-center">
      <div className="relative overflow-hidden w-full max-w-[1340px] bg-[#0a0f1c] rounded-[3rem] py-32 px-6 flex flex-col items-center text-center shadow-2xl">
        ...
        <h2 className="relative z-10 text-4xl md:text-[56px] font-display font-black text-white mb-5 tracking-tight">
        ...
        <Link 
          href="/contrato"
          className="relative z-10 flex items-center justify-center gap-2 px-8 py-4 bg-[#0d52ff] text-white text-[16px] font-bold rounded-xl hover:bg-[#003ee6] transition-all shadow-lg shadow-blue-500/20"
        >
