...
export function HeroSection() {
  ...
  return (
    <section className="relative w-full min-h-[90vh] flex items-center pt-24 pb-20 px-6 overflow-visible">
      {/* Background Image */}
      <div 
      ...
      <div className="absolute inset-0 bg-gradient-to-r from-black/90 via-[#1A1A1A]/80 to-transparent"></div>
