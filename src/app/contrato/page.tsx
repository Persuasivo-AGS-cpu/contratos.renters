...
export default function ContractGeneratorPage() {
  return (
    <div className="flex w-full bg-surface-subtle overflow-hidden h-[calc(100vh-64px)]">
      {/* Columna Izquierda: Engine */}
      <div className="w-full md:w-[650px] lg:w-[700px] flex-shrink-0 flex flex-col pt-8 md:pt-10 mb-6 px-6 md:px-10 border-r border-border-layout bg-surface-clean overflow-y-auto overflow-x-hidden z-10 shadow-lg relative h-full pb-10">
